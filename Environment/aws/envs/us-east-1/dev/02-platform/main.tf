      ...
      template:
        spec:
          requirements:
            ...
            # picking the exact same bad type again. Hit live: a pod sat
            # Pending for 15+ minutes while Karpenter cycled through two
            # separate m1.small launch attempts. Gt "1" exclude gen-1
            # families (m1/c1/t1/...) entirely -- the standard Karpenter
            # best-practice constraint for exactly this failure mode.
